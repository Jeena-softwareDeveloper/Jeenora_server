...
const createCampaign = async (req, res) => {
  try {
    ...
    const campaignData = {
      ...
      trackingEnabled,
      sendOptions: {
        delayBetweenMessages: sendOptions.delayBetweenMessages || 1000,
...
// validatePhoneNumber function removed
...
const sendCampaignToRecipients = async (campaign) => {
  try {
    ...
    const BATCH_SIZE = campaign.sendOptions?.batchSize || 5;
    const BATCH_DELAY = campaign.sendOptions?.delayBetweenMessages || 2000;
