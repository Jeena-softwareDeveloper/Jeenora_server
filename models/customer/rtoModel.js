...
RTOSchema.index({ partnerId: 1, status: 1 });
...
RTOSchema.statics.getSupplierStats = async function(partnerId) {
...
RTOSchema.statics.getSupplierTrends = async function(partnerId) {
