const ChatController = require('../../controllers/wear/chatController')
...
router.get('/chat/seller/get-admin-messages', authMiddleware, ChatController.get_hire_support_messages)
router.post('/chat/seller/support-message', authMiddleware, ChatController.insert_hire_support_message)
