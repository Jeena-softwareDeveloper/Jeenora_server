...
const wearProductSchema = new mongoose.Schema({
    ...
    variants: [{
        ...
        stock: { type: Number, required: true, default: 0 }, // Represents total_stock
...
// 🔹 VIRTUAL: availableStock for each variant
wearProductSchema.virtual('variantsWithAvailable').get(function () {
