const ReturnRequest = require('../../models/customer/returnRequestModel');
const RTO = require('../../models/customer/rtoModel');
...
class ReturnRTOCController {
        ...
        try {
            ...
            responseReturn(res, 200, {
                ...
                stats: {
                    ...
                    reasonsDistribution,
                    qcResults,
                    totalReturns: await ReturnRequest.countDocuments({ partnerId: supplier._id }),
    ...
    get_rto_stats = async (req, res) => {
        ...
        try {
            ...
            const totalRTOs = await RTO.countDocuments({ partnerId: supplier._id });
    ...
    get_combined_dashboard_stats = async (req, res) => {
        ...
        try {
            ...
            // Calculate totals
            const totalReturns = await ReturnRequest.countDocuments({ partnerId: supplier._id });
            const totalRTOs = await RTO.countDocuments({ partnerId: supplier._id });
