...
class SupportCommunicationController {
    ...
    generateMockTickets = (partnerId) => {
        ...
        for (let i = 0; i < 15; i++) {
            ...
            tickets.push({
                ticketId: `TKT-${Date.now() - i * 86400000}-${partnerId.toString().slice(-6)}`,
                partnerId,
                type,
    ...
    generateMockNotifications = (partnerId) => {
        ...
        for (let i = 0; i < 25; i++) {
            ...
            notifications.push({
                id: `NOTIF-${Date.now() - i * 3600000}-${partnerId.toString().slice(-6)}`,
                partnerId,
                type,
