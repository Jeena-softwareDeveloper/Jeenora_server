...
const successStories = [
    {
        heading: "From Arid Land to Lush Green Heaven",
        slug: "detailed-success-story-arumugam",
        name: "Arumugam S.",
        area: "Dharmapuri, TN",
        village: "Pappireddipatti",
        district: "Dharmapuri",
        year: "2023-24",
        crop: "Sugarcane & Millet",
        description: "Arumugam was struggling with extreme water scarcity and rapid soil degradation. His land had become nearly uncultivable due to years of heavy chemical use and monsoon failure.\n\nAfter joining the Jeenora Awareness program, he adopted a comprehensive transformation protocol. This included 100% drip irrigation, localized vermicompost production, and bio-shield pest management. Within just 18 months, his land didn't just recover—it thrived, showing a massive increase in biodiversity and yield.",
        experience: "Yield grew by 140% while input costs dropped by 60%.",
        image: "https://images.unsplash.com/photo-1523348837708-15d4a09cfac2?q=80&w=2000&auto=format&fit=crop",
        before_image: "https://images.unsplash.com/photo-1500382017468-9049fed74a62?q=80&w=2000&auto=format&fit=crop",
        photo: "https://ui-avatars.com/api/?name=Arumugam+S&background=059669&color=fff&size=200",
        yield_before: "1.2 T/AC",
        yield_after: "2.9 T/AC",
        income_before: "₹42,000",
        income_after: "₹1,15,000",
        likes: "1,450",
        techniques: ["Drip Irrigation", "Vermicompost", "Crop Rotation", "Bio-Shield"],
        timeline: [
            { month: "Month 01", event: "Soil testing and immediate chemical cessation" },
            { month: "Month 04", event: "Installation of Jeenora-specified smart drip nodes" },
            { month: "Month 08", event: "First organic harvest with 15% increase" },
            { month: "Month 18", event: "Full soil revival and record-breaking yield status" }
        ]
    },
    {
        heading: "Community-Led Organic Movement Success",
        slug: "community-organic-movement",
        name: "Lakshmi M.",
        area: "Tirunelveli, TN",
        village: "Alwarkurichi",
        district: "Tirunelveli",
        year: "2024",
        crop: "Premium Organic Rice",
